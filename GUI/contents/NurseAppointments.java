...
public class NurseAppointments extends JPanel {
    ...
    public NurseAppointments(String authority) {
    ...
    private void initializeUI() {
        ...
        JLabel titleLabel = new JLabel("Nurse Appointment List");
        ...
        tableModel = appointmentDashboard.getNurseAppointmentsModel(columns);
                ...
                if (e.getClickCount() == 2) {
                    ...
                    if (selectedRow != -1) {
                        try {
                            ...
                            Window windowAncestor = SwingUtilities.getWindowAncestor(NurseAppointments.this);
                            JFrame parentFrame = null;
                            if (windowAncestor instanceof JFrame) {
                                parentFrame = (JFrame) windowAncestor;
                            }

                            new NursePopUp(parentFrame, patientId, NurseAppointments.this);
                            
                        } catch (Exception ex) {
                            ex.printStackTrace(); // Print to console if something goes wrong
                        }
                    }
                }
            }
