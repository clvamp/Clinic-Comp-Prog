...
public class AccountPanel extends JPanel {
    ...
    public AccountPanel(String username, String authority) {
    ...
    private void initializeUI() {
        ...
        accountInfoPanel.setBackground(
        ...
        accountInfoPanel.setPreferredSize(
        ...
        accountInfoPanel.add(
                Box.createRigidArea(new Dimension(80, 60))
        );
        ...
        authorityBox.setMinimumSize(
                new Dimension(300, 42)
        );

        authorityBox.setAlignmentX(
     ...
     editButton.addActionListener(e -> {
        ...
        accountInfoPanel.add(
                Box.createRigidArea(new Dimension(0, 22))
        );
        ...
        JPanel securityCard = createCard(
                "Security Settings",
                "Update password and maintain account protection."
        );

        JPanel accessCard = createCard(
                "System Access",
                "Review authority access and clinic permissions."
        );

        JPanel activityCard = createCard(
                "Account Activity",
                "Monitor recent account actions and security logs."
        );

        JPanel clinicCard = createCard(
                "Clinic Dashboard",
                "Manage clinic dashboard access and workflow."
        );
