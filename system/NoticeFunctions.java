...
public class NoticeFunctions {
    ...
    /* =========================================================
       NEW: ROLE SELECTOR (Patient / Admin)
       ========================================================= */
    public static void chooseRole(Window parent, ClinicAccountSystem system) {
        new NoticeGUI(parent, system);
    }

    /* =========================================================
       BACK TO ROLE SELECTOR
       ========================================================= */
    public static void backToRoleSelector(Window parent, ClinicAccountSystem system) {
        parent.dispose();
        chooseRole(null, system);
    }
}